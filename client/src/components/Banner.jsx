        ...
        <div className="md:w-1/2 space-y-7 px-4">
          <div className="  rounded-3xl shadow-xl  p-8 px-10 bg-simpleLightYellow">
            <h2 className="md:text-4xl text-gray-800 text-4xl font-bold md:leading-snug leading-snug">
              Embark on a Taste Journey: Unleash your Inner Foodie at{" "}
              <span className="text-textYellow ">MR King</span>
            </h2>
            <p className="text-gray-600 text-xl mt-4">
              Nestled in the heart of Kaluthara, MR King invites you to
              experience the magic of Sri Lankan cuisine. We blend age-old
              traditions with modern twists, crafting dishes that tantalize your
              taste buds and transport you to a tropical paradise.
            </p>
            <a href="/menu">
