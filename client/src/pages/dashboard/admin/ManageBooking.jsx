  ...
  return (
    <div className="w-full md:w-[900px] px-4 mx-auto">
      <div className="bg-stone-950 rounded-2xl mt-4 px-4 py-4">
        {/* Header */}
        <h1 className="text-4xl font-bold text-center text-white">Manage Bookings</h1>
            ...
            <tbody>
              {bookingData.map((booking) => (
                <tr key={booking.id} className="bg-stone-950">
                  <td className="py-3 px-6 text-white">{booking.id}</td>
                  <td className="py-3 px-6 text-white">{booking.userName}</td>
                  <td className="py-3 px-6 text-white">{booking.bookingDate}</td>
                  <td className="py-3 px-6 text-white">{booking.time}</td>
                  <td className="py-3 px-6 text-white">{booking.tableNo}</td>
                </tr>
              ))}
            </tbody>
          </table>
