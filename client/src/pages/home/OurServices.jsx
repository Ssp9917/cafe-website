        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <p className="my-5 text-base font-medium text-secondary leading-[30px]">
              Embark on a flavorful journey with MRKing. Our menu blends
              authentic Sri Lankan tastes with modern delights. Enjoy the
              convenience of seamless service, making every bite a delight.
              Welcome to a world where taste meets efficiency!
            </p>
          </div>
        </div>
